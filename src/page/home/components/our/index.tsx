  ...
  return (
    <section className={styles.our}>
      <Container maxWidth='lg'>
        <h2>{t('our.featuresServices')}</h2>
        <p className={styles.our__desc}>{t('our.description')}</p>
        <div className={styles.our__list}>
          {data.map((item) => (
            <div key={item.id} className={styles.our__item}>
              <div
                className={styles.our__img}
                style={{
                  width: '200px',
                  height: '200px',
                  display: 'flex',
